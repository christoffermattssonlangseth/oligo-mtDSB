...
- **Mitochondrial and ER stress signaling**, including the integrated stress response (ISR) and unfolded protein response (UPRmt) (*Atf4, Jun, Hspa5, Hspd1, Hspa9*).  
- **Antigen presentation pathways**, with upregulation of MHC-I molecules (*B2m, H2-D1, H2-K1*) and antigen processing enzymes (*Ctss*), suggesting stressed OLs become visible to the immune system.  
- **Transport and myelin support disruption**, including altered kinesin/dynein motor expression (*Kif5a, Kif5b, Dync1li1*) and adhesion molecules (*Itgb1, Mpzl1*).  
- **Reactivity and glial crosstalk**, reflected by induction of *Ndrg2*, *Gfap*, and calcium-binding proteins (*S100a1, Calb2*).  
- **Inflammatory mediators**, including *Nmu* (neuromedin U) and *Ccl3*, pointing to signaling that may recruit and activate immune cells.
